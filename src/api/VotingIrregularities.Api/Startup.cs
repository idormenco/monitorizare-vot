...
namespace VotingIrregularities.Api
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			{
				options.SwaggerDoc("voting-irregularities-api", new Info
				{
					Version = "v1",
					Title = "VoteMonitor ",
		...
		{
			var pathBase = Configuration["Api:PathBase"];
			...
			app.UseSwaggerUI(c =>
			{
				c.OAuthClientId("AutoApiSwagger");
				c.SwaggerEndpoint("./voting-irregularities-api/swagger.json", "Voting Irregularities Api V1");
			});
